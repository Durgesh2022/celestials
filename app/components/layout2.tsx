    ...
    <div className={`w-full min-h-screen ${inter.className}`}>
      <main className="flex flex-col lg:flex-row items-center justify-between px-4 py-12 md:px-16 max-w-7xl mx-auto text-[#4D5557]">
        ...
        <div className="w-full lg:w-3/5 pr-0 lg:pr-12 mb-8 lg:mb-0">
          <h1 className="font-celestial text-6xl  font-bold mb-6 leading-tight" style={{ fontFamily: "'CelestialFont', Petrona, serif",}}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
            {/* Healing Column */}
            <div>
              <h2 className="text-3xl font-bold mb-3 text-[#4A1A11]" style={{ fontFamily: "'CelestialFont', Petrona, serif",}}>Healing</h2>
              <p className='text-[#4A1A11]'>Promotes relaxation and emotional balance.</p>
            </div>
            
            {/* Growth Column */}
            <div>
              <h2 className="text-3xl font-bold mb-3 text-[#4A1A11]" style={{ fontFamily: "'CelestialFont', Petrona, serif",}}>Growth</h2>
              <p className='text-[#4A1A11]'>Enhances personal and spiritual development.</p>
            </div>
          </div>
        </div>
