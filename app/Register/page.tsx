...
import { apiClient, SignupData } from '@/lib/api-client';
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="space-y-3">
                <div className="flex items-start">
                  ...
                  />
                  <label htmlFor="agreeToTerms" className="ml-3 text-sm text-[#4A1A11]" style={{ fontFamily: 'a Antara Distance' }}>
                ...
                <div className="flex items-start">
                  <input
                    ...
                    className="mt-1 h-4 w-4 text-[#4D5557] focus:ring-[#4D5557] border-[#f6d992] rounded"
                  />
                  <label htmlFor="subscribeNewsletter" className="ml-3 text-sm text-[#4A1A11]" style={{ fontFamily: 'a Antara Distance' }}>
